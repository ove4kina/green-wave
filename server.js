...
app.use('/media', serve('./public/media', true))
...
app.post('/recall', function (req, res) {
    let mailOptions = {
        from: 'Зелёная волна <siteinformingservice@gmail.com>',
        to: 'ksenos.morion@mail.ru',
        subject: 'Заявка',
        html: '<p>Номер телефона: ' + req.body.phone + '</p><p>Имя: ' + req.body.name + '</p><p>Имейл: ' + req.body.email + ' </p>'
    };
